...
def calc_rotary_R_mat(d_head: int, max_seq_len: int, 
                      theta: float = 10000.0, max_rel_dist: int = 10):
    """
    ...
    for j in range(d_head):
        for k in range(d_head):
            ...
            E2[:, k] = 1
            E1, E2 = apply_rotary_emb(E1.unsqueeze(1).unsqueeze(0), E2.unsqueeze(1).unsqueeze(0), freqs_cis=freqs_cis[:max_rel_dist])
...
## a simple way of calculating rotary R matrix
